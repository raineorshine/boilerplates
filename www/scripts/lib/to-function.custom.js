/**
 * Underscore's _.isFunction uniquely identifies functions based on .call and .apply. Adding String.prototype.call and String.prototype.apply breaks this. Modified version of to-function that does not add these to the String prototype.
 */
